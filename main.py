...
def main():
    ...
    print(f"""
+------------------------------------------------------+
|  TRADING BOT  --  Futures Edition                    |
|  Strategy   : S2 -- FVG Retest + EMA50/100 + ADX     |
|  Sizing     : $20 margin x 50x leverage ($1k notion) |
|  Risk       : 0.4% SL / 1.2% TP (RR 3.0)             |
|  Lock Profit: arm at 50% to TP, lock 10% of TP dist  |
